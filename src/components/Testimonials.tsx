    ...
    >
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 lg:mb-16 gap-4">
        ...
        <div className="flex flex-col mb-2">
          <span className="text-white font-bold tracking-widest text-sm md:text-base uppercase pb-2">
            CLIENT
            <br />
            FEEDBACK
          </span>
        ...
        {testimonials.map((t, idx) => (
          ...
          >
            <div>
              ...
              <p className="mt-8 text-xl md:text-2xl font-bold uppercase leading-snug text-brand-dark">
                {t.quote}
              </p>
            </div>
            <div className="mt-16 w-full">
              <div className="h-0.5 w-full bg-brand-dark opacity-30 mb-8"></div>
              <div className="flex items-center gap-6">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[10px] md:text-xs text-brand-dark opacity-70 uppercase font-bold tracking-wider">
                    {t.role}
                  </span>
                </div>
              </div>
